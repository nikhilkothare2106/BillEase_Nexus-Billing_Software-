...
public class ViewEditEmployee {
	...
	private void initialize() {
		...
		lblNewLabel_5_1_1_2.setIcon(new ImageIcon(ViewEditEmployee.class.getResource("/images/edititem.png")));
		...
		lblNewLabel_5_1_1.setIcon(new ImageIcon(ViewEditEmployee.class.getResource("/images/edit.png")));
		...
		lblNewLabel_5_3_1.setBounds(78, 176, 86, 57);
		panel_4.add(lblNewLabel_5_3_1);
		
		JLabel lblNewLabel_5_1_1_1 = new JLabel("");
		lblNewLabel_5_1_1_1.setIcon(new ImageIcon(ViewEditEmployee.class.getResource("/images/additem.png")));
		...
		lblNewLabel_5.setBounds(66, 266, 120, 57);
		...
		lblNewLabel_5_1.setIcon(new ImageIcon(ViewEditEmployee.class.getResource("/images/register.png")));
		...
		lblNewLabel_7.setBounds(0, -26, 228, 642);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(!email.equals("")){
					...
					if(!validate.nameValidation(name)) {
						JOptionPane.showMessageDialog(frame, "Invalid name", "name erroe", JOptionPane.ERROR_MESSAGE);
					}
